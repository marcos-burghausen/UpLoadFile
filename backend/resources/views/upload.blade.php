...
<body>
    ...
    <script type="text/javascript">
        ...
        let resumable = new Resumable({
            target: 'http://localhost:4080/upload',
            query: {
                _token: '{{ csrf_token() }}'
            },
            fileType: ['png', 'jpg', 'jpeg', 'mp4', 'prn'],
            chunkSize: 1 * 1300 * 1300, // default is 1*1024*1024, this should be less than your maximum limit in php.ini
            headers: {
